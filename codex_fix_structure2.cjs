...
const start=lines.findIndex(line=>line.includes('function selectClass(classNumber) {')); 
const searchStart=lines.findIndex(line=>line.includes('function searchStudent() {')); 
const repl=[ 
