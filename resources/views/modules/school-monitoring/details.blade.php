    ...
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white border rounded-xl p-5 shadow-sm">
                    <h2 class="text-lg font-semibold mb-5">Show Attendance Reports</h2>

                    <form action="{{ route('viewspacificdata') }}" method="GET">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                            ...
                            <div>
                                ...
                                <select name="class_id"
                                    ...
                                    @foreach (getClassSchool($school->id) as $class)
                            ...
                            <div>
                                ...
                                <select name="report"
                                    ...
                                    @foreach (AttendanceType() as $items)
                            ...
                            <div class="flex items-end">
                                <button type="submit"
                                    class="py-2 px-2 w-full h-[42px] bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition">
                                    View Report
                                </button>
                            </div>
                            ...
                            <!-- Manual Report -->
                            <div class="flex items-end">
                                <a href="{{ route('manulareport',['school_id'=>$school->id,'name'=>$school->school_name]) }}"
                                    class="py-2 px-2 w-full h-[42px] flex items-center justify-center bg-primary-900 hover:bg-primary-800 text-white font-medium rounded-lg transition">
                                    Reports
                                </a>
                            </div>
