        ...
        <div class="mx-auto max-w-6xl">
            <div class="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    ...
                    <h1 class="mt-2 text-3xl font-semibold text-gray-800">Stats Section Module</h1>
                    <p class="mt-3 max-w-2xl text-sm leading-6 text-gray-500">
                        Manage the key counters shown on the department website with reusable stat cards and labels.
                    </p>
                </div>
            </div>

            <div class="mb-6 flex justify-end">
                {{-- <a href="{{ route('admin.department.cms.stats.edit') }}"
            ...
            <x-cms.department-website-cms.stats.stats-section :states="$states" />
        </div>
    </div>
@endsection
