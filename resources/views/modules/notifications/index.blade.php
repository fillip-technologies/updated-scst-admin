    ...
    <div class="grid grid-cols-3 gap-6">
        ...
        <div class="col-span-1 bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
            ...
            <div class="mb-4">
                ...
                <select class="w-full mt-2 border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    <option>All Schools</option>
                    <option>Principals Only</option>
            ...
            <!-- Button -->
            <button class="w-full bg-primary-900 text-white py-3 rounded-lg font-medium hover:bg-primary-800 transition flex items-center justify-center gap-2">
