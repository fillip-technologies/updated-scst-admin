    ...
    <div class="mx-auto max-w-6xl">
        <div class="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
                ...
                <h1 class="mt-2 text-3xl font-semibold text-gray-800">Homepage Infrastructure Section</h1>
                <p class="mt-3 max-w-2xl text-sm leading-6 text-gray-500">
                    Manage the homepage infrastructure content from this dedicated section page.
                </p>
            </div>
