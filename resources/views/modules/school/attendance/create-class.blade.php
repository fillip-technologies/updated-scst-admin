    ...
    <div class="p-8 bg-gray-100 min-h-screen">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-1 bg-white p-6 rounded-xl shadow h-fit">
                ...
                <form method="POST" action="{{ isset($editdata) ? route('school.update.class',$editdata->id) :  route('school.add.class') }}">
                    @csrf
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="py-3 px-6">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <!-- Edit -->
                                        <a href="{{ route('school.edit.class', $class->id) }}"
                                            class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-xs">
                                            Edit
                                        </a>

                                        <!-- Delete -->
                                        <form action="{{ route('school.delete.class', $class->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <input type="hidden" name="school_id" value="{{ SchoolLogin()->id }}">
