...
<div class="bg-gray-100 min-h-screen">
    ...
    <div class="grid grid-cols-12 gap-6">
            ...
            <div id="classList" class="space-y-2">
                @for ($i = 1; $i <= 10; $i++)
                    <button
                        ...
                        id="class{{ $i }}"
                        class="class-item w-full text-left px-4 py-2 rounded-lg transition {{ $i === 1 ? 'bg-primary-900 text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                        Class {{ $i }}
                    </button>
                @endfor
            </div>
        ...
        <div class="col-span-12 lg:col-span-9 space-y-6">
            <div class="bg-white rounded-xl shadow-sm p-4 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <a
                        href="{{ url('school-management/create') }}"
                    ...
                    <a
                        href="{{ url('school-management/bulk-upload') }}"
                    ...
                    <table class="w-full text-sm">
                        <thead class="bg-gray-50 text-gray-500 uppercase text-xs">
                            <tr>
                                ...
                                <th class="py-3 px-6 text-left">Mother Name</th>
                        ...
                        <tbody id="studentTableBody" class="divide-y"></tbody>
                    </table>
                </div>
            </div>
        </div>
