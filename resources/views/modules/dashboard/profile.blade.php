...
@section('content')
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="px-6 pb-6">
                    ...
                    <div class="mb-4 text-center">
                        <button id="openModal" class="text-sm p-x-2 py-3 p-2 border rounded-xl bg-blue-800 text-white">
                            Change Password?
                        </button>
                    </div>
    ...
    <div id="modal" class="fixed inset-0 bg-opacity-50 hidden items-center justify-center">
        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 relative">
            ...
            <!-- Content -->
            <h2 class="text-xl font-semibold mb-3">Reset Passsword</h2>
            <form id="resetForm" action="{{ route('reset.admin.password') }}" class="space-y-4" method="POST">
                @csrf
                <input type="hidden" value="{{ Auth::user()->role === 'admin' ? Auth::user()->id : '' }}" name="id">
                <!-- Email -->
                <div>
                ...
                <!-- Submit -->
                <button type="submit"
                   class="w-full text-sm p-x-2 py-3 p-2 border rounded-xl bg-blue-800 text-white transition">
                    Update Password
                </button>
