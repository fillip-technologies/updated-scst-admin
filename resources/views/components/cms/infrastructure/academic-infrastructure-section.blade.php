    ...
    <div class="rounded-3xl border border-primary-800/10 bg-white shadow-sm">
        ...
        <div class="p-6 sm:p-8">
            <div class="grid grid-cols-1 gap-6">
                <div>
                    <label for="academic_infra_title" class="mb-2 block text-sm font-medium text-gray-700">Section Title</label>
                    <input
                        id="academic_infra_title"
                ...
                <div>
                    <label for="academic_infra_description" class="mb-2 block text-sm font-medium text-gray-700">Section Description</label>
                    <textarea
                        id="academic_infra_description"
                        x-model="sectionDescription"
                        rows="4"
                ...
                <div class="border-t border-primary-800/10 pt-8">
                    <div class="mb-5 flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Preview and manage all academic infrastructure cards.</p>
                        </div>
                        <span class="rounded-full bg-primary-900/10 px-3 py-1 text-xs font-medium text-primary-900" x-text="`${cards.length} Cards`"></span>
                    </div>
                        ...
                        <template x-for="(card, index) in cards" :key="`${card.title}-${index}`">
                            <div class="group overflow-hidden rounded-3xl border border-primary-800/10 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                                ...
                                <div class="p-5">
                                    ...
                                    <p class="mt-2 text-sm leading-6 text-gray-500 line-clamp-3" x-text="card.description"></p>
                    ...
                    <div class="overflow-hidden rounded-2xl border border-primary-800/10 bg-white shadow-sm">
                        ...
                        <div class="p-4">
                            ...
                            <template x-if="card.link">
                                <div class="mt-3 inline-flex rounded-lg bg-primary-900/5 px-3 py-2 text-xs font-medium text-primary-900" x-text="card.link"></div>
                            </template>
                        </div>
                    </div>
                </template>
    ...
    <div
        ...
        <div class="w-full max-w-4xl rounded-3xl border border-primary-800/10 bg-white shadow-2xl">
            <div class="flex items-start justify-between border-b border-primary-800/10 px-6 py-5 sm:px-8">
                <div>
                    <h3 class="text-xl font-semibold text-gray-800" x-text="editingIndex === null ? 'Add Infrastructure Card' : 'Edit Infrastructure Card'"></h3>
                    <p class="mt-2 text-sm text-gray-500">
            ...
            <div class="p-6 sm:p-8">
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-[260px_minmax(0,1fr)]">
                    <div class="rounded-2xl border border-dashed border-primary-800/20 bg-primary-900/5 p-5 transition hover:border-primary-700 hover:bg-primary-900/10">
                        <label for="infra_card_image" class="mb-2 block text-sm font-medium text-gray-700">Infrastructure Image Upload</label>
                        ...
                        <div class="mt-4 overflow-hidden rounded-2xl border border-primary-800/10 bg-white shadow-sm">
                            <img
                                :src="form.image || 'https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=900&q=80'"
                                alt="Infrastructure card preview"
                    ...
                    <div class="grid grid-cols-1 gap-5">
                        <div>
                            <label for="infra_card_title" class="mb-2 block text-sm font-medium text-gray-700">Infrastructure Title</label>
                            <input
                                id="infra_card_title"
                                x-model="form.title"
                                type="text"
                        ...
                        <div>
                            <label for="infra_card_description" class="mb-2 block text-sm font-medium text-gray-700">Infrastructure Description</label>
                            <textarea
                                id="infra_card_description"
                        ...
                        <div>
                            <label for="infra_card_link" class="mb-2 block text-sm font-medium text-gray-700">Optional Learn More Link</label>
                            <input
                                id="infra_card_link"
                                x-model="form.link"
                                type="text"
