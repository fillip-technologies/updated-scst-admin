    ...
    <div class="rounded-3xl border border-primary-800/10 bg-white shadow-sm">
        ...
        <form class="p-6 sm:p-8" action="{{ isset($heros) ? route('inf.update.hero') : route('inf.save.hero') }}"
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 gap-5 lg:grid-cols-[240px_minmax(0,1fr)]">
                            ...
                            <div class="flex flex-col justify-center">
                                ...
                                <input type="hidden" name="old_image" value="{{ $heros->infra_hero_image ?? "" }}">
                                <input id="infra_hero_image" type="file" accept="image/*" name="infra_hero_image"
                ...
                <div class="md:col-span-2">
                    <label for="infra_hero_title" class="mb-2 block text-sm font-medium text-gray-700">Hero
                        Title</label>
                    <input id="infra_hero_title" value="{{ old('infra_hero_image', $heros->infra_hero_title ?? '') }}"
                        name="infra_hero_title" type="text"
                ...
                <div class="md:col-span-2">
                    <label for="infra_hero_subtitle" class="mb-2 block text-sm font-medium text-gray-700">Hero Subtitle
                        / Description</label>
                    <textarea id="infra_hero_subtitle" rows="5" name="infra_hero_subtitle"
                        class="w-full rounded-xl border border-primary-800/15 bg-white px-4 py-3 text-sm leading-6 text-gray-700 shadow-sm transition focus:border-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-800/20">{{ old('infra_hero_image', $heros->infra_hero_subtitle ?? '') }}</textarea>
                </div>

                <div>
                    <label for="infra_breadcrumb" class="mb-2 block text-sm font-medium text-gray-700">Breadcrumb
                        Title</label>
                    <input id="infra_breadcrumb" type="text" name="infra_breadcrumb" placeholder="Infrastructure" value="{{ old('infra_breadcrumb',$heros->infra_breadcrumb ?? "") }}"
                        class="w-full rounded-xl border border-primary-800/15 bg-white px-4 py-3 text-sm text-gray-700 shadow-sm transition focus:border-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-800/20">
                </div>
            </div>
