@php
    $getdata = json_decode(optional($data)->state_section ?? '{}');
@endphp
...
<div class="rounded-2xl border border-primary-800/10 bg-white shadow-sm">
    ...
    <form class="p-6 sm:p-8" action="{{ route('add.states') }}" method="POST">
        ...
        <input type="hidden" name="id" value="{{ optional($data)->id ?? 1 }}">
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="rounded-2xl border border-orange-200 bg-orange-50/60 p-5">
                ...
                <div class="mt-4 grid grid-cols-1 gap-4">
                    ...
                    <div>
                        <label for="schools_count"
                            class="mb-2 block text-sm font-medium text-gray-700">
                            Schools Count
                        </label>

                        <input id="schools_count"
                            type="text"
                            name="schools_count"
                    ...
                    <div>
                        <label for="schools_label"
                            class="mb-2 block text-sm font-medium text-gray-700">
                            Schools Label
                        </label>

                        <input id="schools_label"
                            type="text"
                            name="schools_label"
            ...
            <div class="rounded-2xl border border-sky-200 bg-sky-50/60 p-5">
                ...
                <div class="mt-4 grid grid-cols-1 gap-4">
                    ...
                    <div>
                        <label for="students_label"
                            class="mb-2 block text-sm font-medium text-gray-700">
                            Students Label
                        </label>

                        <input id="students_label"
                            type="text"
                            name="students_label"
                            placeholder="Enter label"
            ...
            <div class="rounded-2xl border border-emerald-200 bg-emerald-50/60 p-5">
                ...
                <div class="mt-4 grid grid-cols-1 gap-4">
                    ...
                    <div>
                        <label for="teachers_label"
                            class="mb-2 block text-sm font-medium text-gray-700">
                            Teachers Label
                        </label>

                        <input id="teachers_label"
                            type="text"
                            name="teachers_label"
                            placeholder="Enter label"
