    ...
    x-data="{
        staff: [
            ...
            },
            {
                ...
                email: 'ravi.prakash@school.edu'
            },
            {
                image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=900&q=80',
                name: 'Nikita Singh',
                subject: 'English Department',
                email: 'nikita.singh@school.edu'
            }
        ],
        editorOpen: false,
        editingIndex: null,
        ...
        openCreate() {
            ...
            this.form = { image: '', fileName: '', name: '', subject: '', email: '' };
            this.editorOpen = true;
        },
        openEdit(index) {
            this.editingIndex = index;
            this.form = { ...this.staff[index], fileName: '' };
            this.editorOpen = true;
        },
        ...
        saveStaff() {
            ...
            if (this.editingIndex === null) {
                ...
                this.staff[this.editingIndex] = payload;
            }
    ...
    <div class="rounded-3xl border border-primary-800/10 bg-white shadow-sm">
        ...
        <div class="p-6 sm:p-8">
            <div class="mb-5 flex items-center justify-between">
                ...
                <span class="rounded-full bg-primary-900/10 px-3 py-1 text-xs font-medium text-primary-900" x-text="`${staff.length} Staff Members`"></span>
            </div>
    ...
    <div
        ...
        <div class="w-full max-w-4xl rounded-3xl border border-primary-800/10 bg-white shadow-2xl">
            <div class="flex items-start justify-between border-b border-primary-800/10 px-6 py-5 sm:px-8">
                <div>
                    <h3 class="text-xl font-semibold text-gray-800" x-text="editingIndex === null ? 'Add Staff Member' : 'Edit Staff Member'"></h3>
                    <p class="mt-2 text-sm text-gray-500">
            ...
            <div class="p-6 sm:p-8">
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-[260px_minmax(0,1fr)]">
                    <div class="rounded-2xl border border-dashed border-primary-800/20 bg-primary-900/5 p-5 transition hover:border-primary-700 hover:bg-primary-900/10">
                        <label for="staff_image" class="mb-2 block text-sm font-medium text-gray-700">Staff Image Upload</label>
                        ...
                        <div class="mt-4 flex justify-center">
                            <div class="h-32 w-32 overflow-hidden rounded-full ring-4 ring-primary-900/10">
                                <img
                                    :src="form.image || 'https://images.unsplash.com/photo-1544723795-3fb6469f5b39?auto=format&fit=crop&w=900&q=80'"
                                    alt="Staff preview"
                    ...
                    <div class="grid grid-cols-1 gap-5">
                        <div>
                            <label for="staff_name" class="mb-2 block text-sm font-medium text-gray-700">Staff Name</label>
                            <input
                                id="staff_name"
                                x-model="form.name"
                                type="text"
                        ...
                        <div>
                            <label for="staff_subject" class="mb-2 block text-sm font-medium text-gray-700">Subject / Department</label>
                            <input
                                id="staff_subject"
                        ...
                        <div>
                            <label for="staff_email" class="mb-2 block text-sm font-medium text-gray-700">Email Address</label>
                            <input
                                id="staff_email"
                                x-model="form.email"
                                type="email"
