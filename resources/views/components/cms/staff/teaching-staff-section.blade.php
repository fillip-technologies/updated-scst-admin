<div x-data="{
                    ...
                    <div
                        ...
                        <div class="flex flex-col items-center p-6 text-center">
                            ...
                            <div class="mt-5 flex items-center gap-3">
                                ...
                                <button type="button" @click="deleteStaff(index)"
    ...
    <div x-show="editorOpen" x-transition.opacity.duration.200ms
        ...
        <div class="w-full max-w-4xl rounded-3xl border border-primary-800/10 bg-white shadow-2xl">
            ...
            <div class="p-6 sm:p-8">
                <form action="{{ route('staff.save.teacher') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-[260px_minmax(0,1fr)]">
                        <div
                            ...
                            <input id="staff_image" type="file" accept="image/*" @change="handleFileChange($event)" name="staff_image"
                        ...
                        <div class="grid grid-cols-1 gap-5">
                            <div>
                                <label for="staff_name" class="mb-2 block text-sm font-medium text-gray-700">Staff
                                    Name</label>
                                <input id="staff_name" name="staff_name" type="text"
                            ...
                            <div>
                                <label for="staff_subject" class="mb-2 block text-sm font-medium text-gray-700">Subject
                                    / Department</label>
                                <input id="staff_subject" name="staff_subject" type="text"
                                    class="w-full rounded-xl border border-primary-800/15 bg-white px-4 py-3 text-sm text-gray-700 shadow-sm transition focus:border-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-800/20">
                            </div>
                            ...
                            <div class="flex flex-col gap-3 sm:flex-row sm:justify-end">
                                ...
                                <button type="submit" @click="saveStaff()"
