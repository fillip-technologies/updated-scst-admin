    ...
    <div class="rounded-3xl border border-primary-800/10 bg-white p-6 shadow-sm">
        ...
        <div class="mt-6 rounded-3xl border border-primary-800/10 bg-gray-50 p-6 text-center">
            <div class="mx-auto h-28 w-28 overflow-hidden rounded-full ring-4 ring-primary-900/10">
                <img :src="form.image" alt="Leadership preview" class="h-full w-full object-cover">
            </div>
            <h3 class="mt-5 text-2xl font-semibold text-gray-800" x-text="form.name"></h3>
            <p class="mt-2 text-sm font-medium text-primary-900" x-text="form.designation"></p>
            <p class="mt-4 text-sm leading-6 text-gray-500" x-text="form.bio"></p>
        </div>
    </div>
</div>
