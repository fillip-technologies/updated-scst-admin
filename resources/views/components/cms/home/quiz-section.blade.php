                        ...
                        <template x-for="(items, key) in quizzes" :key="key">
                            <div
                                ...
                                <div class="relative overflow-hidden">
                                    ...
                                    <!-- ✅ Image SAME -->
                                    <img :src="'/'+ items.quiz_image" :alt="items.quiz_title"
                                ...
                                <div class="p-5">
                                    ...
                                    <!-- ✅ Title SAME -->
                                    <h3 class="text-lg font-semibold text-gray-800" x-text="items.quiz_title">
                                    </h3>

                                    <!-- ✅ Description SAME -->
                                    <p class="mt-2 text-sm leading-6 text-gray-500" x-text="items.quiz_description">
                                    </p>
                ...
                <div class="p-6 sm:p-8">
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-[260px_minmax(0,1fr)]">
                        <div
                            ...
                            <input id="quiz_image" type="file" accept="image/*" @change="handleFileChange($event)"
                                name="quiz_image"
