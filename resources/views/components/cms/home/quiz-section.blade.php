            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="border-t border-primary-800/10 pt-8">
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                        <template x-for="(quiz, index) in quizzes" :key="`${quiz.title}-${index}`">
                            <div
                                ...
                                <div class="relative overflow-hidden">
                                    ...
                                    <span
                                        :class="quiz.status === 'Ongoing' ?
                                            'bg-accent-500 text-black' :
                                            (quiz.status === 'Upcoming' ?
                                                'bg-white text-primary-900' :
                                                'bg-primary-900 text-white')"
                                        class="absolute left-4 top-4 rounded-full px-3 py-1 text-xs font-semibold shadow-sm"
                                        x-text="quiz.status"></span>
                                </div>

                                <div class="p-5">
                                    <h3 class="text-lg font-semibold text-gray-800" x-text="quiz.title"></h3>
                                    <p class="mt-2 text-sm leading-6 text-gray-500" x-text="quiz.description"></p>

                                    <div class="mt-4 inline-flex rounded-lg bg-primary-900/5 px-3 py-2 text-xs font-medium text-primary-900"
                                        x-text="quiz.buttonText"></div>
                                    ...
                                    <div class="mt-5 flex items-center gap-3">
                                        ...
                                        <button type="button" @click="deleteQuiz(index)"
                ...
                <div class="p-6 sm:p-8">
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-[260px_minmax(0,1fr)]">
                        <div
                            ...
                            <label for="quiz_image" class="mb-2 block text-sm font-medium text-gray-700">Quiz Banner
                                Image Upload</label>

                            <input id="quiz_image" type="file" accept="image/*" @change="handleFileChange($event)" name="quiz_image"
                        ...
                        <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                            <div>
                                <label for="quiz_status" class="mb-2 block text-sm font-medium text-gray-700">Status
                                    Badge</label>
