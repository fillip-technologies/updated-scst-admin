<div
    ...
    <div class="rounded-3xl border border-primary-800/10 bg-white shadow-sm">
        ...
        <form class="p-6 sm:p-8" action="{{ route('glance.save') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    <label for="glance_subtitle" class="mb-2 block text-sm font-medium text-gray-700">Section Subtitle</label>
                    <textarea


                        rows="4"
                        name="glance_subtitle"
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div class="rounded-2xl border border-primary-800/10 bg-white p-4 shadow-sm">
                            ...
                            <div class="mt-4 space-y-4">
                                <div>
                                    <label for="stat_1_value" class="mb-2 block text-sm font-medium text-gray-700">Value</label>
                                    <input
                                ...
                                <div>
                                    <label for="stat_1_label" class="mb-2 block text-sm font-medium text-gray-700">Label</label>
                                    <input
                        ...
                        <div class="rounded-2xl border border-primary-800/10 bg-white p-4 shadow-sm">
                            ...
                            <div class="mt-4 space-y-4">
                                <div>
                                    <label for="stat_2_value" class="mb-2 block text-sm font-medium text-gray-700">Value</label>
                                    <input
                                ...
                                <div>
                                    <label for="stat_2_label" class="mb-2 block text-sm font-medium text-gray-700">Label</label>
                                    <input
                        ...
                        <div class="rounded-2xl border border-primary-800/10 bg-white p-4 shadow-sm">
                            ...
                            <div class="mt-4 space-y-4">
                                <div>
                                    <label for="stat_3_value" class="mb-2 block text-sm font-medium text-gray-700">Value</label>
                                    <input
                                        type="text"
                                        name="stat_3_value"
                                        class="w-full rounded-xl border border-primary-800/15 bg-white px-4 py-3 text-sm text-gray-700 shadow-sm transition focus:border-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-800/20">
                                ...
                                <div>
                                    <label for="stat_3_label" class="mb-2 block text-sm font-medium text-gray-700">Label</label>
                                    <input
                        ...
                        <div class="rounded-2xl border border-primary-800/10 bg-white p-4 shadow-sm">
                            ...
                            <div class="mt-4 space-y-4">
                                <div>
                                    <label for="stat_4_value" class="mb-2 block text-sm font-medium text-gray-700">Value</label>
                                    <input
                                ...
                                <div>
                                    <label for="stat_4_label" class="mb-2 block text-sm font-medium text-gray-700">Label</label>
                                    <input 
                                        type="text"
                                        name="stat_4_label"
                                        class="w-full rounded-xl border border-primary-800/15 bg-white px-4 py-3 text-sm text-gray-700 shadow-sm transition focus:border-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-800/20">
    ...
    <div class="rounded-3xl border border-primary-800/10 bg-white p-6 shadow-sm">
        ...
        <div class="mt-6 rounded-3xl border border-primary-800/10 bg-gray-50 p-5">
            <p class="text-sm font-semibold uppercase tracking-[0.2em] text-primary-700" x-text="form.title"></p>
            <p class="mt-3 text-sm leading-6 text-gray-500" x-text="form.subtitle"></p>

            <div class="mt-6 grid grid-cols-2 gap-4">
                <div class="rounded-2xl bg-primary-900 p-4 text-white shadow-sm">
                    <p class="text-3xl font-semibold" x-text="form.stat1Value"></p>
                    <p class="mt-2 text-sm text-gray-100" x-text="form.stat1Label"></p>
                </div>
                <div class="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-primary-800/10">
                    <p class="text-3xl font-semibold text-gray-800" x-text="form.stat2Value"></p>
                    <p class="mt-2 text-sm text-gray-500" x-text="form.stat2Label"></p>
                </div>
                <div class="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-primary-800/10">
                    <p class="text-3xl font-semibold text-gray-800" x-text="form.stat3Value"></p>
                    <p class="mt-2 text-sm text-gray-500" x-text="form.stat3Label"></p>
                </div>
                <div class="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-primary-800/10">
                    <p class="text-3xl font-semibold text-gray-800" x-text="form.stat4Value"></p>
                    <p class="mt-2 text-sm text-gray-500" x-text="form.stat4Label"></p>
                </div>
            </div>
        </div>
    </div>
