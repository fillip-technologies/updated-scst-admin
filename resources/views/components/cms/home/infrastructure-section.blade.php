            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" name="infra_label"
                        value="{{ old('infra_label', $infrastructure->infra_label ?? '') }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <input id="infra_title" type="text" name="infra_title"
                        value="{{ old('infra_title', $infrastructure->infra_title ?? '') }}"
                        class="w-full rounded-xl border border-primary-800/15 bg-white px-4 py-3 text-sm text-gray-700 shadow-sm transition focus:border-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-800/20">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="infra_description" rows="5" name="infra_description"
                        class="w-full rounded-xl border border-primary-800/15 bg-white px-4 py-3 text-sm leading-6 text-gray-700 shadow-sm transition focus:border-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-800/20">{{ old('infra_description', $infrastructure->infra_description ?? '') }}</textarea>
                </div>
    ...
    <div class="rounded-3xl border border-primary-800/10 bg-white p-6 shadow-sm">
        ...
        <div class="mt-6 rounded-3xl border border-primary-800/10 bg-gray-50 p-5">
            <p class="text-sm font-semibold uppercase tracking-[0.2em] text-primary-700">
                {{ $infrastructure->infra_label ?? '' }}</p>
            <h3 class="mt-3 text-2xl font-semibold leading-tight text-gray-800">{{ $infrastructure->infra_title ?? '' }}
            </h3>
