<aside class="w-[280px] bg-primary-900 text-gray-300 flex flex-col h-full">
   ...
   {{ request()->routeIs('dashboard')
       ...
       : 'text-gray-300 hover:bg-primary-800' }}">
        ...
        {{ request()->routeIs('dashboard') ? 'text-accent-500' : 'text-gray-400' }}"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 13h8V3H3v10zm10 8h8V3h-8v18z" />
                </svg>
            ...
            <div class="mt-2 space-y-1">
                ...
                <!-- School Monitoring -->
                <a href="{{ route('school.monitoring') }}"
                ...
                <div x-data="{ open: false }">
                    ...
                    <button @click="open = !open" type="button"
                        class="w-full flex items-center justify-between gap-4 px-6 py-3 rounded-xl transition">
            ...
            {{ request()->routeIs('admin.syllabus.add') ? 'bg-primary-700 text-white font-medium' : 'text-gray-400 hover:bg-primary-800 hover:text-white' }}">
                ...
                <a href="{{ route('admin.mission.aspire') }}"
                    ...
                    <svg class="w-5 h-5 {{ request()->routeIs('admin.mission.aspire*') ? 'text-accent-500' : 'text-gray-400' }}"
                        fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    {{ request()->routeIs('school.dashboard') ? 'bg-primary-800 text-white' : 'hover:bg-primary-800 text-gray-300' }}">
                ...
                <i
                    class="fa-solid fa-house {{ request()->routeIs('school.dashboard') ? 'text-accent-500' : 'text-gray-400' }}"></i>
                School Dashboard
            </a>
   ...
   {{ request()->routeIs('school.manage-result*') ? 'bg-primary-800 text-white' : 'hover:bg-primary-800 text-gray-300' }}">
    ...
    {{ request()->routeIs('school.manage-result*') ? 'text-accent-500' : 'text-gray-400' }}"></i>
        ...
        {{ request()->routeIs('school.meal') ? 'bg-primary-800 text-white' : 'hover:bg-primary-800 text-gray-300' }}">
                ...
                <i
                    class="fa-solid fa-utensils {{ request()->routeIs('school.meal') ? 'text-accent-500' : 'text-gray-400' }}"></i>
                Meal Reporting
            </a>
        ...
        {{ request()->routeIs('school.infra.*') ? 'bg-primary-800 text-white' : 'hover:bg-primary-800 text-gray-300' }}">
                ...
                <i
                    class="fa-solid fa-building {{ request()->routeIs('school.infra.*') ? 'text-accent-500' : 'text-gray-400' }}"></i>
                Infra Info
            </a>
        ...
        {{ request()->routeIs('school.reports') ? 'bg-primary-800 text-white' : 'hover:bg-primary-800 text-gray-300' }}">
                ...
                <i
                    class="fa-solid fa-file-lines {{ request()->routeIs('school.reports') ? 'text-accent-500' : 'text-gray-400' }}"></i>
                School Reports
            </a>
        ...
        {{ request()->routeIs('school.website-cms') || request()->is('school/website-cms*') ? 'bg-primary-800 text-white' : 'hover:bg-primary-800 text-gray-300' }}">
                ...
                <i
                    class="fa-solid fa-globe {{ request()->routeIs('school.website-cms') || request()->is('school/website-cms*') ? 'text-accent-500' : 'text-gray-400' }}"></i>
                Website CMS
            </a>
   ...
   {{ request()->routeIs('subjects') ? 'bg-primary-800 text-white' : 'hover:bg-primary-800 text-gray-300' }}">
            ...
            <a href="{{ route('staff.school.manage-result') }}"
                class="flex items-center gap-4 px-6 py-3 rounded-xl transition
   {{ request()->routeIs('school.manage-result*') ? 'bg-primary-800 text-white' : 'hover:bg-primary-800 text-gray-300' }}">

                <i
                    class="fa-solid fa-chart-line
    {{ request()->routeIs('staff.school.manage-result*') ? 'text-accent-500' : 'text-gray-400' }}"></i>
